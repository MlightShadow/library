...
* [mozilla/BrowserQuest A HTML5/JavaScript multiplayer game experiment](https://github.com/mozilla/BrowserQuest)
* [azerothcore/azerothcore-wotlk AzerothCore - MMORPG Server. Based on MaNGOS -> TrinityCore -> SunwellCore](https://github.com/azerothcore/azerothcore-wotlk)
...
* [b3log/symphony 一款用 Java 实现的现代化社区（论坛/BBS/社交网络/博客）平台。](https://github.com/b3log/symphony)
...
* [xiangwbs/springboot springboot多模块项目。集成springboot，jpa，mybatis(pagehelper，mybatis-generator)，redis，shiro(shiro分支)，druid，RabbitMQ，log4j2，swagger2，email，rsa加密，基于注解接口幂等设计，基于注解接口限流，全局异常处理，分布式全局id雪花算法，二维码，验证码，文件上传，阿里支付，微信支付，…](https://github.com/xiangwbs/springboot)
* [geekidea/spring-boot-plus Spring-Boot-Plus is a easy-to-use, high-speed, high-efficient,feature-rich, open source spring boot scaffolding.(springboot 高效脚手架)](https://github.com/geekidea/spring-boot-plus)
* [gyoomi/framework 基于Spring Boot 2.0版本，集成MyBatis、Spring Security、Redis、Thymeleaf、Swagger、Quartz、ActiveMQ、Log4j2高性能日志框架、邮件发送、多线程接口等功能的快速开发平台](https://github.com/gyoomi/framework)
* [micyo202/yan 使用Maven构建，整合Dubbo+Zookeeper+SpringMVC+Spring+MyBatis+Redis支持分布式的高效率便捷开发框架](https://github.com/micyo202/yan)
...
* [vasttian/vue-admin-vuetify vue-admin-vuetify is a Front-end component library project based on Vue.js using Vuetify. (一个vue组件库)](https://github.com/vasttian/vue-admin-vuetify)
* [PanJiaChen/vue-element-admin A magical vue admin https://panjiachen.github.io/vue-element-admin (饿了么UI)](https://github.com/PanJiaChen/vue-element-admin)
* [youzan/vant Lightweight Mobile UI Components built on Vue (一个vue组件库)](https://github.com/youzan/vant)
* [code-kotis/qr-code-scanner A simple, fast and useful progressive web application](https://github.com/code-kotis/qr-code-scanner)
...
* [wellcaffeinated/PhysicsJS A modular, extendable, and easy-to-use physics engine for javascript](https://github.com/wellcaffeinated/PhysicsJS)
...
* [MyBeany/mySpringBoot 从零搭建自己的springboot后台框架](https://github.com/MyBeany/mySpringBoot)
* [30-seconds/30-seconds-of-code A curated collection of useful JavaScript snippets that you can understand in 30 seconds or less. (有用的js代码片段)](https://github.com/30-seconds/30-seconds-of-code)
* [you-dont-need/You-Dont-Need-JavaScript CSS is powerful, you can do a lot of things without JS. (css awesome)](https://github.com/you-dont-need/You-Dont-Need-JavaScript)
...
* [jcjohnson/neural-style Torch implementation of neural style algorithm (图片风格转换工具)](https://github.com/jcjohnson/neural-style)
* [luanfujun/deep-photo-styletransfer Code and data for paper "Deep Photo Style Transfer": https://arxiv.org/abs/1703.07511 (图片风格转换工具)](https://github.com/luanfujun/deep-photo-styletransfer)
* [ryankiros/neural-storyteller A recurrent neural network for generating little stories about images (看图讲故事)](https://github.com/ryankiros/neural-storyteller)
* [awentzonline/image-analogies Generate image analogies using neural matching and blending. (匹配混合图像)](https://github.com/awentzonline/image-analogies)
* [alexjc/neural-doodle Turn your two-bit doodles into fine artworks with deep neural networks, generate seamless textures from photos, transfer style from one image to another, perform example-based upscaling, but wait.. (涂鸦转换为精细图片)](https://github.com/alexjc/neural-doodle)
* [harry19902002/image-style-transfor 照片风格转换 项目主要参考Anish Athalye的Github项目 该项目是基于TensorFlow进行的视频图像转化，参考neural style这篇文章。](https://github.com/harry19902002/image-style-transfor)
* [anishathalye/neural-style Neural style in TensorFlow! (照片风格转换)](https://github.com/anishathalye/neural-style)
* [iperov/DeepFaceLab DeepFaceLab is a tool that utilizes machine learning to replace faces in videos. Includes prebuilt ready to work standalone Windows 7,8,10 binary (look readme.md). (换脸)](https://github.com/iperov/DeepFaceLab)
* [lllyasviel/MangaCraft Semi-automatic manga colorization project (半自动绘画上色)](https://github.com/lllyasviel/MangaCraft)
* [lllyasviel/style2paints sketch + style = paints (绘画上色)](https://github.com/lllyasviel/style2paints)
* [NVIDIA/pix2pixHD Synthesizing and manipulating 2048x1024 images with conditional GANs (涂鸦生成照片)](https://github.com/NVIDIA/pix2pixHD)
...
* [xuanhun/PythonHackingBook1 Python黑客编程之极速入门](https://github.com/xuanhun/PythonHackingBook1)
* [jackfrued/Python-100-Days Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days)
* [jlevy/the-art-of-command-line Master the command line, in one page 命令行的艺术](https://github.com/jlevy/the-art-of-command-line)
* [scutan90/DeepLearning-500-questions 深度学习500问，以问答形式对常用的概率知识、线性代数、机器学习、深度学习、计算机视觉等热点问题进行阐述，以帮助自己及有需要的读者。](https://github.com/scutan90/DeepLearning-500-questions)
* [exacity/deeplearningbook-chinese Deep Learning Book Chinese Translation (Deep Learning中文版)](https://github.com/exacity/deeplearningbook-chinese)
...
* [Bypass007/Emergency-Response-Notes 应急响应实战笔记，一个安全工程师的自我修养。](https://github.com/Bypass007/Emergency-Response-Notes)
* [toutiaoio/awesome-architecture 架构师技术图谱，助你早日成为架构师](https://github.com/toutiaoio/awesome-architecture)
* [xiaolai/regular-investing-in-box 定投改变命运 —— 让时间陪你慢慢变富](https://github.com/xiaolai/regular-investing-in-box)
...
* [allmachinelearning/MachineLearning Machine learning resources (机器学习资源)](https://github.com/allmachinelearning/MachineLearning)
* [zlotus/notes-linear-algebra 线性代数笔记](https://github.com/zlotus/notes-linear-algebra)
* [lawlite19/MachineLearning_Python 机器学习算法python实现](https://github.com/lawlite19/MachineLearning_Python)
* [lydiahallie/javascript-questions A long list of (advanced) JavaScript questions, and their explanations Updated weekly! (js灵魂问答)](https://github.com/lydiahallie/javascript-questions)
